        ...
        <div class="col-md-7 col-lg-6 ">
          <div class="form_container">
            ...
            <form action="ajoutappartement.php" method="post">
              <div>
                <input type="text" placeholder="Rental price" name="prix" required/>
              </div>
              <div>
                <input type="text" placeholder="Surface area" name="superficie" required/>
              </div>
              <div>
              ...
              <div>
                <input type="text" placeholder="Adress" name="adresse" required />
              </div>
              <div class="btn_box">
                <button>Add</button>
              </div>
...
$appartementctr=new appartementController();
$appartementctr->insert($appartement);
echo "<script>alert('apartment added successfuly!')</script>";}
?>